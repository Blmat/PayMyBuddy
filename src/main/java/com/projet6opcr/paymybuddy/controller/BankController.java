...
public class BankController {
    ...
    @PostMapping("/profile")
    public String addBankAccount(UserAccount userAccount, @Valid BankAccountDTO bankAccountDTO, Errors errors) {
        ...
        userService.addBankAccount(userAccount.getUserId(),bankAccountDTO);
